...
- Deposit (travel date > 30 days): `50,000 MNT * seats` due in 6 hours after approval
- Near tours (travel date <= 30 days): skip 6-hour deposit and start directly from percentage milestones
