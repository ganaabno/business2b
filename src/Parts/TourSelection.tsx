...
function getTourSourceLabel(sourceTag?: Tour["source_tag"]) {
...
export default function TourSelection({
  ...
  const mergedTours = useMemo(() => {
    ...
    for (const tour of tours) {
      if (!isTourBookableInB2B(tour)) continue;
        ...
        <div className="text-center py-8">
          ...
          {hiddenGlobalToursCount > 0 && (
            <p className="text-sm text-amber-600 mt-2">
              {hiddenGlobalToursCount} synced-from-Global tour
        ...
        <div>
          ...
          {selectedTourData && (
            <div className="mt-2">
              ...
              >
                Source: {getTourSourceLabel(selectedTourData.source_tag)}
              </span>
            </div>
          )}
          {hiddenGlobalToursCount > 0 && (
            <p className="text-amber-600 text-xs mt-2">
              ...
              {hiddenGlobalToursCount > 1 ? "s are" : " is"} hidden until synced
              into B2B.
            </p>
          )}
        </div>
