...
export default function AddTourForm({
  ...
  return (
    <div className="mono-card p-6">
      <h3 className="mono-title text-lg text-gray-900 mb-6 flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewTour({ ...newTour, group_size: e.target.value })
          }
          className="mono-input"
        />
        <input
        ...
        <input
          ...
          onChange={(e) => setNewTour({ ...newTour, airlines: e.target.value })}
          className="mono-input"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <textarea
          ...
          className="mono-input md:col-span-2 resize-none"
          rows={3}
        />
      ...
      <div className="flex justify-end mt-4 gap-2">
        <button
          ...
          disabled={
            !newTour.title || !newTour.country || !newTour.departure_date
          }
          className="mono-button px-6 py-2 disabled:opacity-50"
        >
