    ...
    <div className="mono-card overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200 bg-white space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="mono-title text-2xl text-gray-900">All Tours</h2>
      ...
      {/* TABLE */}
      <div className="mono-table-shell rounded-none border-0">
        <div className="mono-table-scroll">
          <table className="mono-table mono-table--sticky min-w-[1080px]">
            <thead>
              <tr>
                    ...
                    <tr key={tour.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-center">
                        {isEditing ? (
                          ...
                          <span
                            className={`mono-badge px-3 py-1 text-xs font-bold ${
                              tour.status === "active"
                                ? "mono-badge--success"
                        ...
                        <div className="flex items-center justify-center gap-2">
                          {isEditing ? (
                            <>
                              <button
                                onClick={handleSave}
                                className="mono-button mono-button--sm px-2.5 py-2"
                                title="Save"
                              >
                              ...
                              <button
                                ...
                                className="mono-button mono-button--ghost mono-button--sm px-2.5 py-2"
                                title="Cancel"
                              >
                                <X className="w-4 h-4" />
                              </button>
                              ...
                              {isDeleting ? (
                                <>
                                  <button
                                    ...
                                    className="mono-button mono-button--sm px-3 py-1.5"
                                  >
                                    Confirm
                                  </button>
                                  <button
                                    onClick={() => setDeletingId(null)}
                                    className="mono-button mono-button--ghost mono-button--sm px-3 py-1.5"
                                  >
                                    Cancel
                                  </button>
                                </>
