...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error("PassengerListErrorBoundary caught:", error, errorInfo);
  }
      ...
      return (
        <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
          <h1 className="text-red-800">
            Something went wrong with the passenger list.
          </h1>
            ...
            {expandedPassengerId === passenger.id && (
              <div className="p-6 bg-white">
                <PassengerFormFields
                  ...
                  departureDate={passenger.departure_date || ""} // ✅ Pass the actual date
                />
              </div>
            )}
          </div>
